-- =====================================================================
-- СПРАВОЧНИК ПРЕФИКСОВ С ЧАСОВЫМИ ПОЯСАМИ (УЛУЧШЕННАЯ ВЕРСИЯ)
-- =====================================================================
--
...
-- =====================================================================
-- МТС (все префиксы, по умолчанию Москва как наиболее населённый регион)
-- =====================================================================
...
-- =====================================================================
-- Билайн (все префиксы, по умолчанию Москва)
-- =====================================================================
...
-- =====================================================================
-- Мегафон (все префиксы, по умолчанию Москва)
-- =====================================================================
...
-- =====================================================================
-- Теле2 (все префиксы, по умолчанию Москва)
-- =====================================================================
...
('951', 'Теле2', 'Europe/Moscow', 'Москва и ЦФО', 3),
('952', 'Теле2', 'Europe/Moscow', 'Москва и ЦФО', 3),
('953', 'Теле2', 'Europe/Moscow', 'Москва и ЦФО', 3),
...
-- Должно быть:
-- МТС:     20 префиксов (Europe/Moscow)
-- Билайн:  15 префиксов (Europe/Moscow)
-- Мегафон: 19 префиксов (Europe/Moscow)
-- Теле2:   18 префиксов (Europe/Moscow)
-- ИТОГО:   72 префикса
